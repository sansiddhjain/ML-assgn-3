...
cf, tr, te, weights = train_network_single_eg(X_mnist, y_mnist, X_mnist_test, y_mnist_test, layers_dim, 100)
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('accuracy_mnist_relu.png')

plt.figure()
plt.plot(x, cf, 'b-', label='Cost Function')
plt.legend()
plt.savefig('costf_mnist_relu.png')
