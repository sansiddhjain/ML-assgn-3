...
def medians(file):
    """
    Given a csv file, find the medians of the continous attributes for the whole data.
    params(1): 
...
def preprocess(file):
    ...
    for row in reader:
        ...
        # Modify this section to read the file in part c where you split the continous attributes baed on dynamic median values.
